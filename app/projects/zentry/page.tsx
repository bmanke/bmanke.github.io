...
const homeNavItems = [
    { name: "Home", link: "https://bmanke.github.io/" },
];

export default function ZentryProject() {
    return (
            ...
            <div className="max-w-7xl w-full">
                ...
                <section className="relative z-10 py-16 px-4">
                    <div className="max-w-4xl mx-auto text-center">
                        <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-purple mb-8">Project Overview</h2>
                        ...
                        <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-purple mb-8">Technical Stack</h2>
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
                            ...
                            >
                                <div>
                                    <h3 className="text-white font-semibold mb-2">Frontend Framework</h3>
                                    <p className="text-gray-400">React with Vite</p>
                                </div>
                            </Card>
                            ...
                            >
                                <div>
                                    <h3 className="text-white font-semibold mb-2">Styling</h3>
                                    <p className="text-gray-400">TailwindCSS for responsive design</p>
                                </div>
                            </Card>
                            ...
                            >
                                <div>
                                    ...
                                    <p className="text-gray-400">GSAP (GreenSock Animation Platform)</p>
                                </div>
                            </Card>
                            ...
                            >
                                <div>
                                    ...
                                    <p className="text-gray-400">React Hooks</p>
                                </div>
                            </Card>
                            ...
                            >
                                <div>
                                    <h3 className="text-white font-semibold mb-2">Audio Integration</h3>
                                    <p className="text-gray-400">Custom audio handling</p>
                                </div>
                            </Card>
                            ...
                            >
                                <div>
                                    ...
                                    <p className="text-gray-400">Dynamic loading and optimization</p>
                                </div>
                            </Card>
                        </div>
                    </div>
